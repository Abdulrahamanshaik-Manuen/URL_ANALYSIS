...
import { Website, Scan, CheckResult, ConsoleError, NetworkError, HttpError, PerformanceResult, SecurityResult, SeoResult, AccessibilityResult, TechnologyResult } from './Src/Models/index.js';
...
async function testDatabaseIntegration() {
  ...
  try {
    ...
    console.log('2 Testing POST /api/analyze with https://example.com ...');
    ...
    if (scanId && websiteId) {
      ...
      console.log('3 Verifying Persisted MongoDB Documents...');
      ...
      console.log('\n4 Testing REST Query Endpoints...');
